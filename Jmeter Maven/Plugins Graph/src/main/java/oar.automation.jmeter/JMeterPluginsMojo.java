...
/**
 *
 * Main contributor : https://github.com/codecentric/jmeter-graph-maven-plugin/blob/master/src/main/java/de/codecentric/jmeter/JMeterPluginsMojo.java
 * todo => my update with modern plugins that i made (make more generic)
 */
@Mojo(name = "plugin-graph")
